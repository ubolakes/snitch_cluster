...
int main() {
    ...
    l1_a = snrt_l1_alloc_cluster_local(n_elem * sizeof(uint32_t),
                                       sizeof(uint32_t));
    l1_b = snrt_l1_alloc_cluster_local(n_elem * sizeof(uint32_t),
                                       sizeof(uint32_t));
    l1_c = snrt_l1_alloc_cluster_local(n_elem * sizeof(uint32_t),
                                       sizeof(uint32_t));
    l1_d = snrt_l1_alloc_cluster_local(n_elem * sizeof(uint32_t),
                                       sizeof(uint32_t));
    l1_2d_a = snrt_l1_alloc_cluster_local(n_elem * n_rep * sizeof(uint32_t),
                                          sizeof(uint32_t));
